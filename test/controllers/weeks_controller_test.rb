...
class WeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post weeks_url, params: { week: { excersize: @week.excersize, workout_id: @week.workout_id } }
    end
  ...
  test "should update week" do
    patch week_url(@week), params: { week: { excersize: @week.excersize, workout_id: @week.workout_id } }
